...
var pro = "I love programming";
console.log(pro.replace("programming", "JavaScript programming"));


// Challenge 6: Store a string in variable and print the string in console 3 times using repeat method.
var you = "I'm Great \n"
console.log(you.repeat(3))
...
var kalvi = "I am a Kalvian";
var array = kalvi.split(" ")
console.log(array)
...
var time = "Time and Tide wait for none";
console.log(time.indexOf("Ti"))
...
var lyf = "When life gives you lemons make lemonade";
console.log(lyf.includes("lemon"))
...
console.log(change.substring(45,51));
